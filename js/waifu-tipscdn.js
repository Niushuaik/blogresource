...
$('.waifu-tool .fui-home').click(function (){
    window.location = 'http://www.nsk666.fun';
    //w window.location = $('#Header1_HeaderTitle').attr("href")
});
...
function waifuWelcome(){
    var text;
    var SiteIndexUrl = 'www.nsk666.fun:8080';  // 手动指定主页
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'https://api3.fghrsh.net/live2d/model/HyperdimensionNeptunia/nepnep/general/mtn/idle_01.mtn/get/?id='+modelId+'-'+modelTexturesId, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
...
function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: 'https://cdn.jsdelivr.net/gh/Niushuaik/live2d-api@1.0/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
        dataType: "json",
...
function loadOtherModel(){
    ...
    $.ajax({
        cache: false,
        url: 'https://cdn.jsdelivr.net/gh/Niushuaik/live2d-api@1.0/'+modelTexturesRandMode+'/?id='+modelId,
        dataType: "json",
        success: function (result){
